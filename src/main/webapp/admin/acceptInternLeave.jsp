    ...
    <div class="container-fluid">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <h3 class="page-heading mb-4">Request Intern Leaves</h3>
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                    ...
                    <table class="table center-aligned-table">
                      ...
                      <%
                       try {
                           ...
                           String sql = "SELECT r.*, e.* FROM internleave r INNER JOIN intern e ON r.employee_id = e.intern_id";
                        ...
                        <tr class="">
                          ...
                          <%
						        ...
						        if (status == 1) {
						%>
						    <td><form method="post" action="/EmployeeManagement/ConfirmLeaveInternServelet">
						...
						%>
                          <td><a href="deleteInternLeave.jsp?id=<%=id%>" class="btn btn-danger btn-sm">Remove</a></td>
                        </tr>
                        <%
                                 }
                                 con.close();
