    ...
    <div class="container-fluid">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <h3 class="page-heading mb-4">Manage Admin</h3>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method="post" action="/EmployeeManagement/AdminUpdateServelet">
                  <%
                    try {         
                    ...
                    <div class="form-group">
                      <input type="hidden" class="form-control p-input" name="adminId" value="<%= rs1.getString(1)%>">
                    </div>
