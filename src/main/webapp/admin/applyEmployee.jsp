    ...
    <div class="container-fluid">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <h3 class="page-heading mb-4">Apply Employee</h3>
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                      ...
                      <tbody>
                       ...
                       try {
                        ...
                        <tr class="">
                          ...
                          <td><a href="viewEmployeeApplication.jsp?id=<%=mob%>" class="btn btn-primary btn-sm">View</a></td>
                          <td><a href="deleteApplyEmployee.jsp?id=<%=mob%>" class="btn btn-danger btn-sm">Remove</a></td>
                        </tr>
                        <%
                                 }
                                 con.close();
