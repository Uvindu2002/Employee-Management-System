          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="/EmployeeManagement/UpdateLeaveServelet">
                  <%
                    try {         
                  	String mob = request.getParameter("id");
			        con = DBConnect.getConnection();
					String s1 = "SELECT * FROM reqleave WHERE leave_id = ?";
                    ...
                    <div class="form-group">
                      <input type="hidden" class="form-control p-input" name="employeeId" value="<%= rs1.getString(4)%>">
                    </div>
